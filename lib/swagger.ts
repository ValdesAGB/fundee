...
const schemas: Record<string, SchemaObject> = {
    ...
    Product: {
        ...
        properties: {
            ...
            isActive: { type: 'boolean' },
            isAntiGaspillage: { type: 'boolean', description: 'Marque le produit comme anti-gaspillage' },
            categoryId: { type: 'string' },
            category: { $ref: '#/components/schemas/Category' },
            business: { $ref: '#/components/schemas/Business' },
            avgRating: { type: 'number', nullable: true },
            promotionalPrice: { type: 'number', nullable: true, description: 'Prix promotional calculé si une promotion active existe' },
            activePromotion: { type: 'object', nullable: true, description: 'Promotion active associée au produit', properties: { id: { type: 'string' }, title: { type: 'string' }, discountPercent: { type: 'number' }, discountAmount: { type: 'number' }, endDate: { type: 'string', format: 'date-time' } } },
            createdAt: { type: 'string', format: 'date-time' },
        },
    },
    CreateProductRequest: {
        ...
        properties: {
            ...
            categoryId: { type: 'string' },
            images: { type: 'array', items: { type: 'string' } },
            isAntiGaspillage: { type: 'boolean', default: false, description: 'Marquer le produit comme anti-gaspillage' },
        },
    },
    UpdateProductRequest: {
        ...
        properties: {
            ...
            images: { type: 'array', items: { type: 'string' } },
            isActive: { type: 'boolean' },
            isAntiGaspillage: { type: 'boolean', description: 'Marquer le produit comme anti-gaspillage' },
        },
    },

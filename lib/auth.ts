...
const BUSINESS_JWT_SECRET = process.env.BUSINESS_JWT_SECRET || process.env.JWT_SECRET;
...
export function generateBusinessToken(payload: BusinessTokenPayload): string {
    return jwt.sign(payload, BUSINESS_JWT_SECRET as string, { expiresIn: BUSINESS_JWT_EXPIRES_IN });
}

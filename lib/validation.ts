...
export const createPromotionSchema = z
  .object({
    ...
    discountPercent: z
      .number()
      .gt(0, "Le pourcentage de réduction doit être supérieur à 0")
      .max(100)
      .optional(),
    discountAmount: z
      .number()
      .positive("Le montant de la réduction doit être positif")
      .optional(),
  ...
  .refine(
    ...
    {
      message:
        "Soit le pourcentage de réduction soit le montant de la réduction doit être fourni",
    },
  );
